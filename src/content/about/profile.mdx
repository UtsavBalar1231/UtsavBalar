...
### Proficient
<DriverCodeBlock language="rust" title="Primary Skills">
```rust
let proficient = [
    "C", "Rust", "Bash", "AWK",
...
### Semi-Proficient
<DriverCodeBlock language="bash" title="Secondary Skills">
```bash
SKILLS=(
...
### Familiar With
<DriverCodeBlock language="c" title="Additional Skills">
```c
char *familiar[] = {
...
### Tools
<DriverCodeBlock language="rust" title="Development Tools">
```rust
struct Tools {
