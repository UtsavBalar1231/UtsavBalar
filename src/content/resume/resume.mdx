...
<div class="contact-info">
  Surat, Gujarat, IN 395006 | (+91) 7600-529-280 | utsavbalar1231@gmail.com |
  [LinkedIn](https://www.linkedin.com/in/utsavbalar)
</div>

## Summary

Embedded Linux and BSP Engineer pursuing a Master's in Computer Science and Engineering, with hands-on experience in developing embedded systems. Proficient in BSP engineering, Linux kernel development, and hardware enablement for ARM-based platforms.

## Work Experience

### Freelance Linux Kernel Developer

_Self, Surat, Gujarat, IN_  
**Jan 2024 - Present**
...
- Developed custom Linux kernels for Xiaomi's SM8150 and SM8250 devices with power management tuning and custom features
- Built custom Linux kernel for Samsung's Exynos 9611 with AOSP support and hardware enablement
- Created custom AOSP ROMs with latest AOSP and Qualcomm patches, integrated custom features and modifications
- Implemented CI/CD pipelines for multiple projects using GitHub Actions for automated builds and tests

## Education

### Master's in Computer Science and Engineering

_National Institute of Technology, Meghalaya, IN_  
**Expected Jun 2025**

### Bachelor's in Computer Engineering

_UKA Tarsadia University, Gujarat, IN_  
**2019 - 2023**
