...
github: "https://github.com/username/linux-driver-tutorial-03"
featured: true
draft: false
---
...
<DriverCodeBlock language="c" title="kmalloc and kfree basics">
```c
...
<DriverCodeBlock language="c" title="Common GFP flags">
```c
...
<DriverCodeBlock language="c" title="vmalloc and vfree example">
```c
...
<DriverCodeBlock language="c" title="get_free_pages example">
```c
...
<DriverCodeBlock language="c" title="kmem_cache example">
```c
...
<DriverCodeBlock language="c" title="DMA memory allocation example">
```c
...
<DriverCodeBlock language="c" title="Coherent DMA allocation">
```c
/* Already shown above */
dma_buffer = dma_alloc_coherent(dev, dma_size, &dma_handle, GFP_KERNEL);
/* ... use the buffer ... */
...
<DriverCodeBlock language="c" title="Streaming DMA mapping">
```c
...
<DriverCodeBlock language="c" title="Setting DMA mask for Raspberry Pi peripherals">
```c
...
<DriverCodeBlock language="c" title="mmap implementation in a driver">
```c
...
<CodeBlock language="c" title="User space mmap example">
```c
#include <stdio.h>
#include <stdlib.h>
#include <fcntl.h>
...
<DriverCodeBlock language="c" title="memdriver.c">
```c
...
<DriverCodeBlock language="makefile" title="Makefile">
```makefile
obj-m := memdriver.o
...
<CodeBlock language="c" title="memdriver_test.c">
```c
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
