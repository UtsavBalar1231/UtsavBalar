...
<CodeBlock language="c" title="kmalloc and kfree basics">
```c
...
<CodeBlock language="c" title="Common GFP flags">
```c
...
<CodeBlock language="c" title="vmalloc and vfree example">
```c
...
<CodeBlock language="c" title="get_free_pages example">
```c
...
<CodeBlock language="c" title="kmem_cache example">
```c
...
<CodeBlock language="c" title="DMA memory allocation example">
```c
...
<CodeBlock language="c" title="Coherent DMA allocation">
```c
/* Already shown above */
dma_buffer = dma_alloc_coherent(dev, dma_size, &dma_handle, GFP_KERNEL);
/* ... use the buffer ... */
...
<CodeBlock language="c" title="Streaming DMA mapping">
```c
...
<CodeBlock language="c" title="Setting DMA mask for Raspberry Pi peripherals">
```c
...
<CodeBlock language="c" title="mmap implementation in a driver">
```c
...
<CodeBlock language="c" title="memdriver.c">
```c
