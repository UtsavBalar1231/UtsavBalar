...
<CodeBlock language="c" title="file_operations example">
```c
...
<CodeBlock language="c" title="simple_char.c - Part 1: Device Structure">
```c
...
<CodeBlock language="c" title="simple_char.c - Part 2: File Operations">
```c
...
<CodeBlock language="c" title="simple_char.c - Part 3: Module Init/Exit">
```c
...
<CodeBlock language="c" title="Dynamic device number allocation">
```c
...
<CodeBlock language="c" title="User space memory access">
```c
...
<CodeBlock language="bash" title="/etc/udev/rules.d/99-simple-char.rules">
```bash
...
<CodeBlock language="c" title="test_device.c">
```c
#include <stdio.h>
#include <stdlib.h>
#include <fcntl.h>
...
<CodeBlock language="c" title="Multiple devices example">
```c
...
<CodeBlock language="c" title="ioctl implementation">
```c
...
<CodeBlock language="c" title="User space ioctl example">
```c
#include <sys/ioctl.h>
#include <fcntl.h>
#include <stdio.h>
