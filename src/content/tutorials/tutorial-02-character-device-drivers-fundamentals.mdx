...
github: "https://github.com/username/linux-driver-tutorial-02"
featured: true
draft: false
---
...
<DriverCodeBlock language="c" title="file_operations example">
```c
...
<DriverCodeBlock language="c" title="simple_char.c - Part 1: Device Structure">
```c
...
<DriverCodeBlock language="c" title="simple_char.c - Part 2: File Operations">
```c
...
<DriverCodeBlock language="c" title="simple_char.c - Part 3: Module Init/Exit">
```c
...
<DriverCodeBlock language="c" title="Dynamic device number allocation">
```c
...
<DriverCodeBlock language="c" title="User space memory access">
```c
...
<DriverCodeBlock language="bash" title="/etc/udev/rules.d/99-simple-char.rules">
```bash
...
<DriverCodeBlock language="c" title="test_device.c">
```c
#include <stdio.h>
#include <stdlib.h>
#include <fcntl.h>
...
<DriverCodeBlock language="c" title="Multiple devices example">
```c
...
<DriverCodeBlock language="c" title="ioctl implementation">
```c
...
<DriverCodeBlock language="c" title="User space ioctl example">
```c
#include <sys/ioctl.h>
#include <fcntl.h>
#include <stdio.h>
