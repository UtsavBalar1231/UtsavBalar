...
<CodeBlock language="c" title="hello.c">
```c
...
<CodeBlock language="c" title="Module Metadata">
```c
MODULE_LICENSE("GPL");
...
<CodeBlock language="markdown" title="Module Metadata Explanation">
```markdown
...
<CodeBlock language="c" title="Module Initialization Function">
```c
static int __init hello_init(void)
{
    printk(KERN_INFO "Hello World: Module loaded\n");
...
<CodeBlock language="c" title="Module Cleanup Function">
```c
static void __exit hello_exit(void)
{
    printk(KERN_INFO "Hello World: Module unloaded\n");
...
<CodeBlock language="c" title="Function Registration">
```c
module_init(hello_init);
module_exit(hello_exit);
```
...
<CodeBlock language="c" title="hello_param.c">
```c
