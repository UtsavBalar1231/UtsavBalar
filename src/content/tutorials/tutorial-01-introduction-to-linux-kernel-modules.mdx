...
github: "https://github.com/username/linux-driver-tutorial-01"
featured: true
draft: false
---
...
<DriverCodeBlock language="c" title="hello.c">
```c
...
<DriverCodeBlock language="c" title="Module Metadata">
```c
MODULE_LICENSE("GPL");
...
<DriverCodeBlock language="markdown" title="Module Metadata Explanation">
```markdown
...
<DriverCodeBlock language="c" title="Module Initialization Function">
```c
static int __init hello_init(void)
{
    printk(KERN_INFO "Hello World: Module loaded\n");
...
<DriverCodeBlock language="c" title="Module Cleanup Function">
```c
static void __exit hello_exit(void)
{
    printk(KERN_INFO "Hello World: Module unloaded\n");
...
<DriverCodeBlock language="c" title="Function Registration">
```c
module_init(hello_init);
module_exit(hello_exit);
```
...
<DriverCodeBlock language="c" title="hello_param.c">
```c
