        ...
        langs: [
          {
            ...
            grammar: {
              patterns: [
                ...
                {
                  match:
                    "\\b(compatible|model|reg|ranges|status|phandle|interrupt-parent|interrupts|dma-ranges|dma-coherent|gpio-controller|#gpio-cells|#interrupt-cells|#clock-cells|clocks|clock-names|resets|reset-names|power-domains|operating-points-v2|cpu-supply|pins|function|groups|pinctrl-[0-9]+|linux,phandle)\\b",
